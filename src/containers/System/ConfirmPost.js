                    ...
                    <table className="w-full">
                        <thead>
                            <tr className='bg-redcover text-white'>
                                ...
                                <th className="px-2 py-3 border text-center text-xs font-bold uppercase">Thời gian</th>
                                <th className="px-2 py-3 border text-center text-xs font-bold uppercase">Người đăng</th>
                                <th className="px-2 py-3 border text-center text-xs font-bold uppercase">Xem chi tiết</th>
                            ...
                            {postsStatus?.length === 0 ? (
                                ...
                                postsStatus.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="px-2 py-3">{formatTime(item?.created)}</td>
